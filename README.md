...
<div align="center">
  <img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,vue,angular,nodejs,express,graphql,apollo,redux,html,css,sass,tailwind,bootstrap,mongodb,postgres,mysql,sqlite,redis,mongoose,python,django,flask,java,kotlin,cpp,docker,kubernetes,terraform,ansible,nginx,apache,linux,ubuntu,centos,kali,metasploit,nmap,wireshark,burpsuite,sqlmap,aircrack,git,github,gitlab,jenkins,postman,vercel,heroku,aws,gcp,firebase,figma,notion,slack,storybook" height="150" />
</div>
